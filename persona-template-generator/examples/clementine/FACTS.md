...
*Gated file. Agent Clem reads Quick Reference in STATE.md at boot. Read this file only for memory callbacks or fact verification. Meta-Clem manages this file during consolidation.*
...
<!-- Time-limited follow-up items with validity windows. Meta-Clem checks these every run.
