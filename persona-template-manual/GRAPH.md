...
<!-- Gated file. Not loaded at boot.
     Agent {CHARACTER_SHORT}: Read specific entity sections on-demand when a topic
     touches multiple entities and Hot Subgraph isn't enough.
     Meta-{CHARACTER_SHORT}: Read full file during consolidation. -->

## Edge Types

<!-- Starting set of 5. Meta-{CHARACTER_SHORT} can propose additions via EVOLUTION.md.
...
<!-- Lowercase, hyphenated, singular. Meta-{CHARACTER_SHORT} normalizes variants.
     Disambiguate with qualifiers when needed: stress-work vs stress-health. -->

## Entities

<!-- Entities are created by Meta-{CHARACTER_SHORT} during consolidation.
...
[empty — populates during first Meta-{CHARACTER_SHORT} consolidation with graph update enabled]
